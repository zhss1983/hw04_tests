...
class PostURLTestsCase(BaseTestCase):
    ...
    def test_absolute_path_by_name(self):
        ...
        urls_by_name = (
            ...
            (cls.url_profile, f'/user/{cls.user.username}/'),
            (cls.url_group, f'/group/{cls.group.slug}/'),
            (cls.url_post, f'/user/{cls.user.username}/{cls.post.pk}/'),
            (cls.url_post_edit, f'/user/{cls.user.username}/{cls.post.pk}/edit/'),
            (cls.url_post_delete,
             f'/user/{cls.user.username}/{cls.post.pk}/delete/'),
        )
...
class CommentURLTestCase(BaseTestCase):
    ...
    def test_absolute_path_by_name(self):
        ...
        self.assertEqual(url_add_comment, f'/user/{user}/{post}/comment/')
...
class FollowURLTestCase(BaseTestCase):
    ...
    def test_absolute_path_by_name(self):
        ...
        urls_by_name = (
            ...
            (cls.url_profile_follow, f'/user/{cls.user_follow.username}/follow/'),
            (cls.url_profile_unfollow,
             f'/user/{cls.user_follow.username}/unfollow/'),
        )
        for name, url in urls_by_name:
            with self.subTest(name=name):
                self.assertEqual(name, url)
